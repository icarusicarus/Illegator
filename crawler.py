        ...
        if((struct.internal and (struct.depth < internal_depth)) or (not struct.internal and (struct.depth < external_depth))):
            ...
            if (len(hrefs)):
                for href in hrefs:
                    ...
                    if is_exist != None and (href.attrs["href"] not in crawled_list) and \
                        ('naver' not in href.attrs["href"]) and ('daum' not in href.attrs["href"]) and \
                            ('google' not in href.attrs["href"]) and ('nate' not in href.attrs["href"]) and \
                                ('youtube' not in href.attrs["href"]) and ('instagram' not in href.attrs["href"]) and\
                                    ('facebook' not in href.attrs["href"]) and ('zum' not in href.attrs["href"]):
